 ...
 */
package edu.sils.companion.interaction;
...
import edu.sils.companion.recipes.*;
/**
 ...
 */
public class CompanionSpeechlet implements Speechlet {
    private static final Logger log = LoggerFactory.getLogger(CompanionSpeechlet.class);
    ...
    public SpeechletResponse onLaunch(final LaunchRequest request, final Session session)
        ...
        String speechOutput =
                "Welcome Rashnil. I am your digital Constant Companion. You can ask a question like, what's is my brothers birthday? or how you are feeling?";
    ...
    private SpeechletResponse getRecipe(Intent intent) {
        ...
        if (itemSlot != null && itemSlot.getValue() != null) {
            ...
            if (recipe != null) {
                ...
                // item.
                String speechOutput =
                        "I'm sorry, I currently do not know the answer for" + itemName + ". What else can I help with?";
    ...
    private SpeechletResponse getHelp() {
        String speechOutput =
                "You can ask questions such as, when is my mothers birthday, or, you can say exit.";
        String repromptText =
                "You can ask questions such as, when is my mothers birthday, or, you can say exit.";
        return newAskResponse(speechOutput, repromptText);
    }
